...
describe('Auth Module', () => {
  ...
  describe('POST /auth/login', () => {
    it('should login successfully with valid credentials', async () => {
      ...
      mockPrisma.user.findUnique = spy(() => Promise.resolve(mockUser as never));
  ...
  describe('POST /auth/refresh', () => {
    it('should refresh tokens successfully', async () => {
      ...
      mockPrisma.session.findUnique = spy(() => Promise.resolve(mockSession as never));
  ...
  describe('POST /auth/reset-password', () => {
    it('should reset password with valid token', async () => {
      ...
      mockPrisma.passwordReset.findUnique = spy(() => Promise.resolve(mockToken as never));
      mockPrisma.user.update = spy(() => Promise.resolve({ id: 'user_123' } as never));
  ...
  describe('POST /auth/verify-email', () => {
    it('should verify email with valid token', async () => {
      ...
      mockPrisma.emailVerification.update = spy(() => Promise.resolve({} as never));
    ...
    it('should reject invalid token', async () => {
      mockPrisma.emailVerification.findUnique = spy(() => Promise.resolve(null));
