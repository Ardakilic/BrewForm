...
describe('Notification Module', () => {
  ...
  describe('GET /notifications', () => {
    it('should return user notifications', async () => {
      ...
      mockPrisma.notification.findMany = spy(() => Promise.resolve(mockNotifications));
  ...
  describe('POST /notifications/:id/read', () => {
    it('should mark notification as read', async () => {
      ...
      mockPrisma.notification.findUnique = spy(() => Promise.resolve(mockNotification));
      mockPrisma.notification.update = spy(() => Promise.resolve(updatedNotification));
  ...
  describe('POST /notifications/read-all', () => {
    it('should mark all notifications as read', async () => {
      mockPrisma.notification.updateMany = spy(() => Promise.resolve({ count: 5 }));
  ...
  describe('DELETE /notifications/:id', () => {
    it('should delete notification', async () => {
      ...
      mockPrisma.notification.findUnique = spy(() => Promise.resolve(mockNotification));
      mockPrisma.notification.delete = spy(() => Promise.resolve(mockNotification));
