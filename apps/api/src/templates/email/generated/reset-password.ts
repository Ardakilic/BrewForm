// Auto-generated from reset-password.mjml
...
<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <style media="screen and (min-width:480px)">
      ...
      >We received a request to reset your password. Click the button below to choose a new one.</div>
      ...
      >
        <tbody>
          <tr>
            ...
            >
              <a
                 href="{{reset_url}}" style="display:inline-block;background:#6F4E37;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;" target="_blank"
              >
                Reset Password
              </a>
            </td>
      ...
      >This link expires in 1 hour. If you didn't request this, you can safely ignore this email.</div>
