  ...
  describe("CacheKeys", () => {
    ...
    describe("userByUsername", () => {
      it("should generate username cache key", () => {
        expect(CacheKeys.userByUsername("coffeemaster")).toBe(
          "user:username:coffeemaster",
        );
      });
    });
    ...
    describe("recipeBySlug", () => {
      it("should generate recipe slug cache key", () => {
        expect(CacheKeys.recipeBySlug("perfect-espresso")).toBe(
          "recipe:slug:perfect-espresso",
        );
      });
    });
    ...
    describe("equipment", () => {
      it("should generate equipment cache key", () => {
        expect(CacheKeys.equipment("grinder", "grinder_123")).toBe(
          "equipment:grinder:grinder_123",
        );
      });
    });
