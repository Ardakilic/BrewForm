  ...
  describe('Unit System Conversions', () => {
    describe('toCanonicalUnits', () => {
      ...
      it('should convert imperial weight to grams', () => {
        expect(toCanonicalUnits(1, 'weight', 'imperial')).toBeCloseTo(
          28.3495,
          2,
        );
      });
      ...
      it('should convert imperial volume to ml', () => {
        expect(toCanonicalUnits(1, 'volume', 'imperial')).toBeCloseTo(
          29.5735,
          2,
        );
      });
      ...
      it('should convert imperial temperature to Celsius', () => {
        expect(toCanonicalUnits(200, 'temperature', 'imperial')).toBeCloseTo(
          93.3,
          1,
        );
      });
    ...
    describe('fromCanonicalUnits', () => {
      ...
      it('should convert grams to imperial weight', () => {
        expect(fromCanonicalUnits(28.3495, 'weight', 'imperial')).toBeCloseTo(
          1,
          2,
        );
      });
      ...
      it('should convert ml to imperial volume', () => {
        expect(fromCanonicalUnits(29.5735, 'volume', 'imperial')).toBeCloseTo(
          1,
          2,
        );
      });
      ...
      it('should convert Celsius to imperial temperature', () => {
        expect(fromCanonicalUnits(93, 'temperature', 'imperial')).toBeCloseTo(
          199.4,
          1,
        );
      });
