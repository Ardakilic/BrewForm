...
Field-by-field comparison between two versions of the same recipe.
...
- No diff of `additionalPreparations` (loaded but not compared)
- No inline editing from the diff view
- No 3-way diff (only 2 versions at a time)
