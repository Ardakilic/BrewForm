...
**All ledgered D-items are resolved.** The D99 deferred-debt ledger ([`plans/D99-debts.md`](D99-debts.md)) is fully closed: D99.1–.19 all resolved. _(Wave 2 resolved 2026-07-06: D03, D34, D39 Tier 1. Wave 3 resolved 2026-07-06: D36, D37, D40. Wave 4 resolved 2026-07-07: D35, D42, D43, D39 Tier 2/3 — via `wave-4-independent-fillers`. Wave 5 resolved 2026-07-27: D99.1,.3,.5,.6,.7,.9,.10–.16,.19 — via `wave-5-debt-clearance`. Remaining-debt-clearance resolved 2026-07-27: D99.4,.8,.17,.18.)_
...
**All deferred items resolved.** The 2026-07-19 audit re-verified all open D99 items against code; wave-5-debt-clearance resolved D99.1,.3,.5,.6,.7,.9,.10–.16,.19 (2026-07-27) and remaining-debt-clearance resolved D99.4,.8,.17,.18 (2026-07-27). The D99 ledger is fully closed.
...
- **D99.17 — Architecture deviations — ✅ Resolved (2026-07-27, remaining-debt-clearance).** Threaded recipe index.ts through service layer (6 wrappers), replaced follow/badge direct drizzle imports with user model functions, documented contact module as accepted deviation.
- **D99.18 — Test-file naming split — ✅ Resolved (2026-07-27, remaining-debt-clearance).** Renamed 6 `*_test.ts` files to `*.test.ts`, codified convention in AGENTS.md and lint-style spec.
...
**Recently resolved (2026-07-27, remaining-debt-clearance):** D99.4 (removed lone `security: []` from collection/index.ts — aligned with omit convention), D99.8 (rewrote `buildCursorWhere` to row-value comparison `(created_at, id) < ($1, $2)` for composite index sargability — D03 raw-SQL exception), D99.17 (threaded recipe index.ts through service layer, replaced follow/badge direct drizzle imports with user model functions, documented contact module as accepted deviation), D99.18 (renamed 6 `*_test.ts` files to `*.test.ts`, codified convention in AGENTS.md and lint-style spec). The D99 ledger is now fully closed.
